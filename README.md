...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) [![Language](https://img.shields.io/badge/Language-HTML/CSS/JS-green.svg)](https://github.com/kriss2012/advanced-emergency-messenger)
...
```mermaid
flowchart TD
    UI[User Interface / Client] --> Core[Application Logic]
```
